      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-14 lg:gap-20 px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="w-full lg:w-[60%] flex flex-col justify-center space-y-7">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 text-emerald-100 px-3.5 py-2.5 rounded-full w-fit border border-emerald-400/30 shadow-[0_10px_40px_rgba(16,185,129,0.18)]">
            ...
            <span className="text-sm font-semibold">Open to work: freelance or full-time frontend roles</span>
          </div>
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-2xl">
            HTML, CSS, JavaScript, React, React Suite, Tailwind, Bootstrap, React Router DOM, Redux, GitHub, Figma,
            Adobe Illustrator, Postman | Studying backend development (Node.js, databases)
          </p>
        ...
        <button
          ...
          className="bg-blue-500 px-5 py-5 flex items-center justify-center rounded-full hover:bg-blue-600 border-2 border-blue-950 fixed right-8 bottom-8 shadow shadow-blue-900/40"
