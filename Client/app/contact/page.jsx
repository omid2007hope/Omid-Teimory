...
const description =
  "Contact frontend developer Omid Teimory. Open to work and collaborations. Reach out for freelance projects, product builds, or full-time roles.";
      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
            ...
            <button type="submit" className="w-full py-4 bg-blue-600 hover:bg-blue-700 rounded-xl font-semibold transition text-lg">
              Send Message
            </button>
